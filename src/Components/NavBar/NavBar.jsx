        ...
        <>
            <div className="header-sec">
                <div className="wrapper">
                    <div className="header-row">
                            ...
                            <div className="cart-sec">
                                <div className="cart-menus">
                                    <div className="cart-icons">
                                        <form role="search" method="get" className="search-form form">
                                            ...
                                            {isUserDropdownOpen && (
                                                <div className="user-dropdown">
                                                    <Link to="/Login" className="user-dropdown-item">
                                                        <span><img src={login} alt="" /></span> Login
                                                    </Link>
                                                    <Link to="/Register" className="user-dropdown-item">
                                                        <span><img src={signup} alt="" /></span> Signup
                                                    </Link>
                                                </div>
                                            )}
                                        </div>
                        ...
                        <form role="search" method="get" className="search-form form mobilemenu">
                            <button type="submit" className="search-submit button">
                                <img src={search} alt="Search" />
                            </button>
                            <input
            ...
            <div className={`mobile-menu-panel ${isMenuOpen ? "open" : ""}`}>
                ...
                <div className="mobile-menu-footer">
                    <button className="login-btn"><img src={user} alt="user" />Login</button>
            ...
            {(isCartOpen || isMenuOpen) && (
                <div className="overlay" onClick={() => { setIsCartOpen(false); setIsMenuOpen(false); }} />
            )}
        </>
    );
}
